...
// ✅ Configuration Redis pour BullMQ avec variables d'env
const connectionOptions: QueueOptions["connection"] = {
  host: process.env.REDIS_HOST || "127.0.0.1",
  port: parseInt(process.env.REDIS_PORT || "6379"),
  password: process.env.REDIS_PASSWORD,
  // Pour Upstash (SSL nécessaire)
...
// Mapping pratique pour accéder aux queues dynamiquement
...
// Export des classes utiles de BullMQ
export { Worker, Job }